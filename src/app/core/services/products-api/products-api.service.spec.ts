...
describe('ProductsApiService', () => {
  ...
  it('should be getAllProductsToUser successful', () => {
    ...
    const request = httpMock.expectOne('https://run.mocky.io/v3/9862c578-93a5-4e97-bbbf-966d286ff1dc')
  ...
  it('should be getAllTransactionToAccount successful', () => {
    ...
    const request = httpMock.expectOne('https://run.mocky.io/v3/97281e7a-59b1-4c99-9cce-3626b61106d3')
    expect(request.request.method).toBe('POST');
    request.flush(responseMock,{
      headers:{
        "X-UUID-USER":"xx1"
